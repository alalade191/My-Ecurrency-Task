...
export const FaqTab = () => {
  return (
    <div className="w-full lg:mt-20 px-5 md:px-8 lg:px-20 relative lg:mb-[185px] mb-[100px]">
      <Tabs defaultValue="product">
        <div className="lg:flex gap-10 items-start h-full">
          <div>
            <TabsList className=" px-5 h-full flex lg:flex-col items-start lg:gap-6 gap-4 rounded-none pb-0">
              <TabsTrigger
                value="product"
              ...
              >
                <p className=" flex items-center justify-center text-semibold text-lg lg:text-2xl">
                  Sleepstiq Product
                </p>
              </TabsTrigger>
              <TabsTrigger
